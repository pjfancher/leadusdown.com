		...
		<header id="header" class="row clearfix">
			<?php if(brunelleschi_option('header-order') === 'Text on Top' || brunelleschi_option('header-order') === 'Text on the Left' || ! brunelleschi_option('header-order') ) : ?>
				<div id="branding" class="<?php if( brunelleschi_option('header-order') === 'Text on the Left' ) { echo 'threecol'; } else { echo 'twelvecol last'; } ?>">
					...
					<a href="<?php echo home_url( '/' ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home"><img style="padding:44px 0 10px 0px;" src="/wp-content/themes/leadusdown_brunelleschi_child/images/leadusdown_underwood_logo98.png" /></a> <!-- logo image -->
...
<div id="soc-menu">
	<a id="twitter-menu" href="http://twitter.com/#!/leadusdown"></a>
	<a id="facebook-menu" href="http://www.facebook.com/pages/Lead-Us-Down/218419848199479"></a>
	<a id="rss-menu" href="http://www.leadusdown.com/feed/rss/"></a>
</div>
				</div><!-- #access -->
			<?php endif; ?>
		</header><!-- #header -->
