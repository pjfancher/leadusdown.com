...
<?php if ( have_comments() ) : ?>
	...
	<div id="commentspost">
		...
		<h3><span><?php comments_number(__('No Comments', 'wpzoom'), __('1 Comment', 'wpzoom'), __('% Comments', 'wpzoom')); ?></span></h3>
	...
	<?php if ('open' == $post->comment_status) : ?><!-- If comments are open, but there are no comments. -->
		...
		<div id="commentspost">
 			<h3><span><?php _e('0 Comments', 'wpzoom'); ?></span></h3>
...
<?php if ('open' == $post->comment_status) : ?>
	...
	<div id="respond">
		...
		<h3><span><?php comment_form_title( __('Leave a Comment', 'wpzoom'), __('Leave a Reply','wpzoom')); ?></span></h3>
		...
		<form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform">
			...
			<?php else : ?>
				...
				<div id="formLabels">
					...
					<p><input type="text" name="author" id="author" value="<?php echo $comment_author; ?>" size="32" tabindex="1" /><label for="author"><?php _e('Name', 'wpzoom') ?> <?php if ($req) ?> (<?php _e('required', 'wpzoom'); ?>)</label></p>

 
					<p><input type="text" name="email" id="email" value="<?php echo $comment_author_email; ?>" size="32" tabindex="2"  /><label for="email"><?php _e('Email', 'wpzoom') ?> <?php if ($req) ?> (<?php _e('required', 'wpzoom'); ?>)</label></p>
