...
$themename = "Yamidoo PRO Magazine";
$shortname =  "wpzoom";

$options = array (

array(    "name" => "Yamidoo PRO Magazine Settings",
        "type" => "title"),
...
array(  "name" => "Display Prev/Next Post",
         "id" => $shortname."_singlepost_next",
		"options" => array('Show', 'Hide'),
		"std" => "Show",
		"type" => "select"),   
...
array(    "name" => "Show slideshow on homepage?",
        "desc" => "Choose <strong>Yes</strong> if you want to show the jQuery slideshow on the homepage.",
        "id" => $shortname."_slideshow_show",
        "options" => array('Yes','No'),
        "std" => "Yes",
        "type" => "select"),

array(    "name" => "Slideshow Category",
        "desc" => "Select the category which you want to show in the Slideshow Section. It could be a category named 'Featured'",
...
array(    "name" => "Slideshow Autoplay Interval",
        "desc" => "Select the interval (in miliseconds) at which the slideshow should change posts (<strong>if autoplay is enabled</strong>). Default: 3000 (3 seconds).",
...
array(    "type" => "preheader",
          "name" => "4 Featured Categories Blocks"),   
                     
array(    "name" => "Show 4 featured categories after slideshow on homepage?",
        "desc" => "Choose <strong>Yes</strong> if you want to show the 4 featured categories blocks on the homepage.",
        "id" => $shortname."_featured_category_show",
        "options" => array('No','Yes'),
        "std" => "No",
        "type" => "select"),
...
array(    "name" => "Should thumbnails for Featured Categories have the same height?",
         "id" => $shortname."_thumb_height",
        "options" => array('No','Yes'),
        "std" => "No",
        "type" => "select"),
        
array(    "name" => "If YES, then specify the height (in pixels)",
         "id" => $shortname."_thumb_height_px",
        "std" => "160",
        "type" => "text"),
...
array(    "name" => "Show Latest Tweet on Homepage?",
        "desc" => "",
...
array(    "name" => "<img align='left' style='padding:0px 3px 0 0;' src='$homepath/images/twitter2.png' />Show Twitter icon in Main Menu?",
        "desc" => "",
        "id" => $shortname."_twitter_head",
        "options" => array('Yes','No'),
        "std" => "Yes",
        "type" => "select"),
        
        
array(    "name" => "<img align='left' style='padding:0px 3px 0 0;' src='$homepath/images/facebook2.png' />Show Facebook icon in Main Menu?",
        "desc" => "",
        "id" => $shortname."_facebook_head",
        "options" => array('Yes','No'),
        "std" => "Yes",
        "type" => "select"),        
...
array(    "type" => "preheader",
          "name" => "Custom Field (if used in a previous theme for thumbnails)"), 
 
         
array(    "name" => "Did your previous theme used custom fields for thumbnails?",
        "desc" => "If you choose <strong>Yes</strong>, then theme will use images added via custom fields for thumbnails.",
...
array(    "name" => "Custom Field name",
        "desc" => "<strong>Used only if you checked <u>Yes</u> in the drop-down above.</strong>",
        "id" => $shortname."_cf_photo",
        "std" => "image",
        "type" => "text"),

array(    "type" => "preheader",
          "name" => "Footer Tracking Script"), 
...
array(    "type" => "preheader",
 ...
 array(    "name" => "Show Contact Widget in the Footer?",
        "desc" => "Choose <strong>Yes</strong> if you want to show a widget with contact information in the Footer",
        "id" => $shortname."_info_show",
        "options" => array('Yes','No'),
        "std" => "Yes",
        "type" => "select"),
                

array(    "name" => "<img align='left' style='padding:0px 3px 0 0;' src='$homepath/images/twitter.png' />Twitter Username",
        "desc" => "Your twitter username<br /> Example:<strong> wpzoom</strong>",
        "id" => $shortname."_twitter",
        "std" => "",
        "type" => "text"),
        
array(    "name" => "<img align='left' style='padding:0px 3px 0 0;' src='$homepath/images/twitter.png' />Twitter Title",
        "desc" => "Text that appears as a heading in the Contact Widget for Twitter. Default: Follow us on Twitter",
        "id" => $shortname."_twitter_heading",
        "std" => "Follow us on Twitter",
        "type" => "text"), 
        
        
array(    "name" => "<img align='left' style='padding:0px 3px 0 0;' src='$homepath/images/facebook.png' />Facebook Profile or Page URL",
        "desc" => "Your full Facebook Profile or Page URL<br /> Example:<strong> http://www.facebook.com/wpzoom</strong>",
        "id" => $shortname."_facebook",
        "std" => "",
        "type" => "text"),
        
array(    "name" => "<img align='left' style='padding:0px 3px 0 0;' src='$homepath/images/facebook.png' />Facebook Title",
        "desc" => "Text that appears as a heading in Footer for Facebook. Default: Become our Friend",
        "id" => $shortname."_facebook_heading",
        "std" => "Become our Friend",
        "type" => "text"), 
        
array(    "name" => "<img align='left' style='padding:0px 3px 0 0;' src='$homepath/images/phone.png' />Contact Phone",
        "desc" => "Your Phone Number<br /> Example:<strong> (565) 204-3012 </strong>",
        "id" => $shortname."_phone",
        "std" => "",
        "type" => "text"),
        
array(    "name" => "<img align='left' style='padding:0px 3px 0 0;' src='$homepath/images/email.png' />Your e-mail",
        "desc" => "Email address<br /> Example:<strong> hello@wpzoom.com</strong>",
        "id" => $shortname."_email",
        "std" => "",
        "type" => "text"),     
...
<div id="zoomWrap">
  <div id="zoomHead">
    ...
    <div id="zoomInfo"><ul><li class="documentation"><a href="http://www.wpzoom.com/documentation/yamidoo_pro.pdf">Documentation</a></li><li class="support"><a href="http://www.wpzoom.com/forum" target="_blank">Support Forum</a></li></ul></div>
  </div>
